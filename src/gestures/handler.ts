...
export class GestureHandler {
  // FIXME: This is getting really long. Should probably split into separate handlers?
  ...
  private handlePointerMove = (e: PointerEvent): void => {
    ...
    if (this.isPinching && this.pointers.size === 2) {
      ...
      const delta = newZoom / this.pinchStartZoom - 1;
    ...
    // TODO: This math is kinda hacky, needs proper calibration
